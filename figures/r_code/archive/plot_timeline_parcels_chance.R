# Figure -- Parcellations v. Chance -- Timeline Data
...
# data
m.data    <- c(.466, .488, .509, .507, .536, .555, .484, .486, .460, .484, .427, .431) #means
sd.data   <- c(.008, .010, .011, .013, .018, .016, .010, .015, .010, .009, .011, .011) #sd's
se.data   <- c(.002, .003, .003, .004, .006, .005, .003, .005, .003, .003, .003, .004) #se's
...
hz_line_lab <- annotate(x = chance, y = 5, label = 'chance')
