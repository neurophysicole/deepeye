...
%some of these files are busted, skip them
    ...
    for i = 1:n_trials
        ...
        trial_data{i} = [zeros(length(edf_data.Samples.posX(samp_inds)),1) edf_data.Samples.posY(samp_inds) edf_data.Samples.pupilSize(samp_inds)];
...
save('confirmatory_timeline_no_x_eyelink_data_coded_flat.mat','good_trial_data_coded_flat', 'good_trial_data_trialtype_labels', 'good_trial_data_subject_labels', '-v7.3')
save('confirmatory_timeline_no_x_eyelink_data_interp_flat.mat','good_trial_data_interp_flat', 'good_trial_data_trialtype_labels', 'good_trial_data_subject_labels', '-v7.3')
save('confirmatory_timeline_no_x_eyelink_data_2000_coded_flat.mat','good_trial_data_2000_coded_flat', 'good_trial_data_trialtype_labels', 'good_trial_data_subject_labels', '-v7.3')
save('confirmatory_timeline_no_x_eyelink_data_2000_interp_flat.mat','good_trial_data_2000_interp_flat', 'good_trial_data_trialtype_labels', 'good_trial_data_subject_labels', '-v7.3')
save('confirmatory_timeline_no_x_eyelink_data_img.mat','imdata', 'good_trial_data_trialtype_labels', 'good_trial_data_subject_labels', '-v7.3')
...
save('confirmatory_timeline_no_x_eyelink_data_centered.mat','centered_data', 'good_trial_data_trialtype_labels', 'good_trial_data_subject_labels', '-v7.3')
save('confirmatory_timeline_no_x_eyelink_data_standardized.mat','standardized_data', 'good_trial_data_trialtype_labels', 'good_trial_data_subject_labels', '-v7.3')
save('confirmatory_timeline_no_x_eyelink_data_normalized01.mat','normalized_data', 'good_trial_data_trialtype_labels', 'good_trial_data_subject_labels', '-v7.3')
