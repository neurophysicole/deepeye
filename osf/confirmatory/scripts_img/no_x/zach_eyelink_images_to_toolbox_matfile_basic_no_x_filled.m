function zach_eyelink_images_to_toolbox_matfile_basic_no_x_filled

image_folder = '/Volumes/eeg_data_analysis/04_mike_eye_tracking/messin_around/z/confirming_initial_model/exp_9_nochanges/image_set/no_x/filled/images';
image_pattern = '*.png';
image_dim1 = 180;
image_dim2 = 240;
resize_factor = .5; %needs to be exact
outfile = 'exp9_kkequated_image_no_x_filled_8301_trials';
