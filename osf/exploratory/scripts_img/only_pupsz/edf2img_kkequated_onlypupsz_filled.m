...
output_folder = '/Volumes/eeg_data_analysis/04_mike_eye_tracking/messin_around/z/confirming_initial_model/exp_1_img_kkequated/only_pupsz/filled/images';
min_trial_length = 6000;
marker_size = 350;
output_file_pattern = 'exp1_img_kkequated_onlypupsz_filled_overall_trial_%.5d_subj%.3d_trialtype%d_blocktype%d.png';
