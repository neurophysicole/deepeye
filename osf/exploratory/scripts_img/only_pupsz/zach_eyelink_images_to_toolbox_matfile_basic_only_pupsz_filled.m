...
image_folder = '/Volumes/eeg_data_analysis/04_mike_eye_tracking/messin_around/z/confirming_initial_model/exp_1_img_kkequated/only_pupsz/filled/images';
image_pattern = '*.png';
image_dim1 = 180;
image_dim2 = 240;
resize_factor = .5; %needs to be exact
outfile = 'exp1_kkequated_image_only_pupsz_filled_12634_trials';
