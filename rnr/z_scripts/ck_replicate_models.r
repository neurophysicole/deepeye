...
setwd("~/Box/projects/deepeye/dev_git/deepeye/rnr/z_scripts/")

source("../ref_code-replicate_and_compare/Coco_Keller/MyCenter.R")
source("../ref_code-replicate_and_compare/Coco_Keller/F-score.R")
...
write.csv(ans, '~/Box/projects/deepeye/dev_git/deepeye/rnr/ck_replicate_model_output.csv')